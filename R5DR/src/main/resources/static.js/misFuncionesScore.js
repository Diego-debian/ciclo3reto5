function traerInformacion(){
    $.ajax({
        url:"http://129.151.111.172:8080/api/Score/all",
        type:"GET",
        datatype:"JSON",
...
function guardarInformacion(){
	if($('#messageText').val() !="" && $('#calificar').val() !="" && $('#idReservation').val() !="Seleccione..."){
		...
		$.ajax({
			url : 'http://129.151.111.172:8080/api/Reservation/'+selected,
			type : 'GET',
			dataType : 'json',
			contentType: "application/json; charset=utf-8",
...
function editarRegistro(id){
    $.ajax({
        url:'http://129.151.111.172:8080/api/Score/'+id,
        type:'GET',
        datatype:'JSON',
        contentType: "application/json; charset=utf-8",
...
function editarInformacion(){
    ...
    $.ajax({
        url:"http://129.151.111.172:8080/api/Score/update",
        type:"PUT",
        data:dataToSend,
