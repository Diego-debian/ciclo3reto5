...
function guardarInformacion(){
    ...
    $.ajax(
        'http://129.151.111.172:8080/api/Client/save',
        {data:datosJson,
        type:"POST",
        datatype:"json",
        contentType: "application/json; charset=utf-8",
...
function editarRegistro(dato){
    $.ajax({
        url:'http://129.151.111.172:8080/api/Client/'+dato,
        type:'GET',
        datatype:'JSON',
        contentType: "application/json; charset=utf-8",
...
function editarInformacion(){
    ...
    $.ajax(
        'http://129.151.111.172:8080/api/Client/update',
        {data: dataToSend,
        type:'PUT',
        datatype:'JSON',
        contentType: "application/json; charset=utf-8",
...
function borrarElemento(id){
    $.ajax({
        url:'http://129.151.111.172:8080/api/Client/'+id,
        type:'DELETE',
        datatype:'JSON',
        contentType:"application/json; charset=utf-8",
