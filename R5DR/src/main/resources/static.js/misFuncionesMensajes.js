...
function guardarInformacion(){
    ...
    $.ajax(
        'http://129.151.111.172:8080/api/Message/save',
        {data:datosJson,
        type:"POST",
        datatype:"json",
        contentType: "application/json; charset=utf-8",
...
function pintarSelect2(id){
	$.ajax({
    url : 'http://129.151.111.172:8080/api/Client/all',
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function editarRegistro (id){
	$.ajax({
    url : 'http://129.151.111.172:8080/api/Message/'+id,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function editarInformacion(){
    ...
    $.ajax({
        url:"http://129.151.111.172:8080/api/Message/update",
        type:"PUT",
        data:dataToSend,
...
function borrarElemento(registro){
    $.ajax({
        url:'http://129.151.111.172:8080/api/Message/'+registro,
        type:'DELETE',
        datatype:'JSON',
        contentType:"application/json; charset=utf-8",
