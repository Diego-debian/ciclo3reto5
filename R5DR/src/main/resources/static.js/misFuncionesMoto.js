...
function guardarInformacion(){
    ...
    $.ajax(
        'http://129.151.111.172:8080/api/Motorbike/save',
        {data:datosJson,
        type:"POST",
        datatype:"json",
        contentType: "application/json; charset=utf-8",
...
function editarRegistro (id){
	$.ajax({
    url : 'http://129.151.111.172:8080/api/Motorbike/'+id,
    type : 'GET',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function editarInformacion(){
    ...
    let datosJson=JSON.stringify(myData);
	$.ajax(
    'http://129.151.111.172:8080/api/Motorbike/update',
	{data: datosJson,
    type : 'PUT',
    dataType : 'json',
    contentType: "application/json; charset=utf-8",
...
function borrarElemento(registro){
    $.ajax({
        url:'http://129.151.111.172:8080/api/Motorbike/'+registro,
        type:'DELETE',
        datatype:'JSON',
        contentType:"application/json; charset=utf-8",
